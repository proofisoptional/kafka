...
import com.example.kafkaconsumer1.entity.OrderEvent;
...
public class KafkaMessagingService {
    ...
    @Transactional
    @KafkaListener(topics = topicCreateOrder, groupId = kafkaConsumerGroupId, properties = {"spring.json.value.default.type=com.example.kafkaconsumer1.entity.OrderEvent"})
